...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.MainStackedWidget.setGeometry(QtCore.QRect(20, 10, 681, 731))
        ...
        self.reg_preimum_code_entry = QtWidgets.QLineEdit(parent=self.Register)
        self.reg_preimum_code_entry.setGeometry(QtCore.QRect(570, 260, 111, 22))
        self.reg_preimum_code_entry.setObjectName("reg_preimum_code_entry")
        self.reg_preimum_code_label = QtWidgets.QLabel(parent=self.Register)
        self.reg_preimum_code_label.setGeometry(QtCore.QRect(570, 240, 101, 21))
        self.reg_preimum_code_label.setObjectName("reg_preimum_code_label")
        ...
        self.Home_InnerSW.setGeometry(QtCore.QRect(10, 50, 661, 671))
        ...
        self.newchat_btn.setGeometry(QtCore.QRect(400, 130, 95, 24))
        ...
        self.menu_made_by.setGeometry(QtCore.QRect(610, 750, 111, 21))
        self.menu_made_by.setObjectName("menu_made_by")
        self.menu_page_title = QtWidgets.QLabel(parent=self.Home)
        self.menu_page_title.setGeometry(QtCore.QRect(250, 50, 161, 51))
        self.menu_page_title.setObjectName("menu_page_title")
        
        self.broadcast_frame = QtWidgets.QFrame(parent=self.Chats_List)
        self.broadcast_frame.setGeometry(QtCore.QRect(120, 530, 441, 131))
        self.broadcast_frame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.broadcast_frame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.broadcast_frame.setObjectName("broadcast_frame")
        
        self.broadcast_title = QtWidgets.QLabel(parent=self.broadcast_frame)
        self.broadcast_title.setGeometry(QtCore.QRect(0, 20, 391, 91))
        self.broadcast_title.setObjectName("broadcast_title")
        
        self.broadcast_entry = QtWidgets.QLineEdit(parent=self.broadcast_frame)
        self.broadcast_entry.setGeometry(QtCore.QRect(0, 40, 421, 22))
        self.broadcast_entry.setObjectName("broadcast_entry")
        
        self.broadcast_history = QtWidgets.QLabel(parent=self.broadcast_frame)
        self.broadcast_history.setGeometry(QtCore.QRect(15, 75, 391, 91))
        self.broadcast_history.setObjectName("broadcast_history")
        self.broadcast_history.setStyleSheet("background-color: white;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.reg_preimum_code_label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:700;\">Premium Code</span></p></body></html>"))
        ...
        self.newchat_btn.setText(_translate("MainWindow", "Search Contact"))
        ...
        self.menu_made_by.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:8pt; font-weight:700;\">Made by 100715281</span></p></body></html>"))
        self.menu_page_title.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:24pt; font-weight:700;\">Contacts</span></p></body></html>"))
        self.broadcast_history.setText(_translate("MainWindow", "<html><head/><body><p vertical-align=\"top\"; align=\"center\"><br/></p></body></html>"))
        self.broadcast_title.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><br/></p></body></html>"))